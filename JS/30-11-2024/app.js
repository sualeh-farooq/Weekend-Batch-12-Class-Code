...
// student.name = 'Anas' // update
// student.score = 80 // add
...
//     var watchProduct = watches[brands][products];
//     productsRow.innerHTML += `
//     <div>
//     <h4> ${watchProduct.name} </h4>
//     <img src="${watchProduct.img}" width="50" height="50" />
//     <button onClick="addProduct('${watchProduct}')" >   Add to Cart </button>
//     </div>
//     `;
//   }
// }
...
// console.log(student.details.getFullName())
...
function renderQuestion() {
    ...
    var questionOptions = document.getElementsByName('option') 

    for(var i = 0; i < questionOptions.length; i++ ) {
      if(questionOptions[i].checked) {
        console.log(questionOptions[i].value)
        console.log(htmlQuiz[currentQuestion - 1].answer)
        
        // if(questionOptions[i].value  === htmlQuiz[currentQuestion].answer) {
        //     score++
        // }
